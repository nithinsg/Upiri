...
- No real photography anywhere yet. The Knowledge Hub and procedure cards now
  carry illustrated artwork (`public/kh/*.webp`, generated by `npm run artwork`),
  which is a large improvement on the eight reused stroke icons — but they are
  illustrations, not photographs. Real clinical photography has to come from
  Yashoda.
